...
@section('title')
{{ __('home/sidebar.all_planeReservations') }}
@endsection
@section('header')
<!-- icheck -->
...
<section class="content-header">
    <h1>{{ __('home/sidebar.all_planeReservations') }} <small>it all starts here</small></h1>
    <ol class="breadcrumb">
        <li><a href="{{ url('\adminCpanel') }}"><i class="fa fa-dashboard"></i> {{ __('home/sidebar.HOME') }} </a></li>
        <li class="active"> {{ __('home/sidebar.all_planeReservations') }} </li>
    </ol>
</section>
...
<section class="content">
    ...
    <!-- /.box -->
    @include('reservation::planereservation.add')
</section>
<!-- /.content -->
