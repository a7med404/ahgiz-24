                    ...
                    <div class="form-group row">
                        <div class="col-md-3 custom-input">
                            ...
                            {!! Form::label('phone_number', 'Phone Number', ['class' => 'custom-label']) !!}
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        <div class="col-md-3 custom-input">
                            ...
                            {!! Form::label('email', 'E-Mail', ['class' => 'custom-label']) !!}
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        <div class="col-md-3 custom-input">
                            ...
                            {!! Form::label('profile_image', 'Profile Image', ['class' => 'custom-label']) !!}
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-3 custom-input">
                            ...
                            {!! Form::label('password', 'Password', ['class' => 'custom-label']) !!}
                        </div>
                        <div class="col-md-3 custom-input">
                            ...
                            {!! Form::label('password-confirm', 'Password Confirm', ['class' => 'custom-label']) !!}
                        </div>
                    </div>
                    @endif
                    ...
                    <div class="form-group row">
                        <div class="col-md-3 custom-label-checkbox-radio">
                            {!! Form::label('is_dealer', 'Is dealer', ['class' => 'custom-label']) !!} <br />
                    ...
                    <div class="form-group row">
                        <div class="col-md-3 custom-input">
                            ...
                            {!! Form::label('dealer_name', 'dealer Name', ['class' => 'custom-label']) !!}
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-md-3 custom-label-checkbox-radio">
