...
<section class="content-header">
    ...
    <section class="content">
        ...
        <div class="col-md-3">
          ...
          <div class="box box-primary">
            <div class="box-body box-profile">
              <img class="profile-user-img img-responsive img-circle" src="{{ getLogo($companyInfo->logo)  }}" alt="User profile picture">

              <h3 class="text-center">{{ $companyInfo->name }}</h3>
              ...
              <ul class="list-group list-group-unbordered">
                ...
                <li class="list-group-item">
                  <b>عدد المركبات</b> <a class="pull-left">{{ $companyInfo->vehicles->count() }}</a>
                </li>
                <li class="list-group-item">
                  <b>Friends</b> <a class="pull-left">13,287</a>
                </li>
              </ul>
              <a href="{{ route('companies.edit',  ['id' => $companyInfo->id]) }}" class="btn btn-primary btn-block"><b>تعديل بيانات الشركة</b></a>
            </div>
            <!-- /.box-body -->
          </div>
          <!-- /.box -->
        ...
        <div class="col-md-9">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs pull-right">
              ...
              <li><a href="#vehicles" data-toggle="tab">{{ __('home/sidebar.vehicles') }} </a></li>
            ...
            <div class="tab-content">
              ...
              <div class="tab-pane" id="vehicles">
                  ...
                  <hr>
                  <div class="row">
                    @foreach ($companyInfo->vehicles as $vehicle)
                    <div class="col-md-4">
                      <div class="box box-success box-shadow">
                        <div class="box-header with-border">
                          <h3 class="box-title">{{ $vehicle->name }} <i class="fa fa-map-marker"></i> </h3>
              ...
              <div class="tab-pane" id="contact">
                ...
                <hr>
                <div class="row">
                  @foreach ($companyInfo->contacts as $contact)
                  <div class="col-md-4">
                    <div class="box box-success box-shadow">
                      <div class="box-header with-border">
      ...
      <!-- /.row -->
      @include('address::addresses.add', ['companyInfo' => $companyInfo])
      @include('address::contacts.add', ['companyInfo' => $companyInfo])
    </section>
    <!-- /.content -->
