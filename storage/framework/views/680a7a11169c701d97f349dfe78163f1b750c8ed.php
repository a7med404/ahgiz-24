    ...
    <div class="modal-dialog" tabindex="-1" role="dialog" aria-labelledby="popup-form" aria-hidden="true">
        <div class="modal-content modal-content-box">
            ...
            <div class="modal-body">
                <?php echo Form::open(['route' => ['customers.store'], 'method' => "POST", 'class' => 'form']); ?>
...
<!-- ... end Popup  -->
<?php /**PATH /home/a7med404/a7meD404/WD_WORK/WorkingFolder/work-on/a7giz-24/Modules/Customer/Providers/../Resources/views/customers/add.blade.php ENDPATH**/ ?>