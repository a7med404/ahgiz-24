...
<?php echo e(__('home/sidebar.all_next_trip')); ?>
...
<section class="content-header">
    <h1>عــدد <?php echo e(__('home/sidebar.all_next_trip')); ?> <?php echo e($trips->count()); ?></h1>
    <ol class="breadcrumb">
...
<script type="text/javascript">
    var lastIdx = null;
        ...
        var table = $('#data').DataTable({
            ...
            autoWidth: false,
            select: true,
            ajax: '<?php echo route('next-dataTables'); ?>',
            columns: [
...
<?php echo $__env->make('adminCpanel.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/barca/fouad/works/a7jiz/a7giz-24/Modules/Vehicle/Providers/../Resources/views/trips/next.blade.php ENDPATH**/ ?>