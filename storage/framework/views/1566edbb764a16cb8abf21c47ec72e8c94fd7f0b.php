...
<section class="content">
    ...
    <div class="box box-info">
        <div class="box-header with-border">
            ...
            <button type="button" data-toggle="modal" data-target="#popup-form" href="#" class="btn btn-info"> <i class="fa fa-user-plus"></i> <?php echo e(__('home/sidebar.add_station')); ?> </button>
                ...
                <table id="table_id" class="table table-bordered table-hover table-condensed">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <?php if($station->type == 1): ?>{
                                <td><?php echo e('محــطة طـيران'); ?></td>
                            }<?php else: ?>{
                                <td><?php echo e('محــطة بصـات'); ?></td>
                            }
                            <?php endif; ?>
                            <td><?php echo e(getCity()[$station->city]); ?></td>
                            <td>
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li role="presentation"><a role="menuitem" tabindex="-1" href="<?php echo e(route('stations.edit',  ['id' => $station->id])); ?>">تعديل</a></li>
                                        <li role="presentation"><a role="menuitem" tabindex="-1" href="#">طباعة</a></li>
                                        <li role="presentation" class="divider"></li>
                                        <li role="presentation"><a role="menuitem" tabindex="-1" class="delete-confirm" href="<?php echo e(route('stations.delete',['id' => $station->id])); ?>">حذف</a></li>
                                    </ul>
                                </div>
                            </td>
                        </tr>
        ...
        <div class="box-footer">
            العدد الكلي: <?php echo e($stations->count()); ?>
...
<?php echo $__env->make('cpanel.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/barca/fouad/works/a7jiz/a7giz-24/Modules/Vehicle/Providers/../Resources/views/stations/index.blade.php ENDPATH**/ ?>