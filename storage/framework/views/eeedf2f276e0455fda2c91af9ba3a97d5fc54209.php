...
<section class="content-header">
    ...
    <section class="content">
            ...
            <div class="box-body box-profile">
              ...
              <ul class="list-group list-group-unbordered">
                <li class="list-group-item">
                  <b> عدد التذاكر المتاحة</b> <a class="pull-left"><span class="label label-success"><?php echo e($tripInfo->seats_number - $reservedSeats); ?></span></a>
                </li>
                <li class="list-group-item">
                  <b> عدد التذاكر المحجوزة</b> <a class="pull-left"><span class="label label-danger"><?php echo e($reservedSeats); ?></span></a>
                </li>
                <li class="list-group-item">
      ...
      <!-- /.row -->
      <?php echo $__env->make('reservation::reservations.add', ['tripInfo' => $tripInfo], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
