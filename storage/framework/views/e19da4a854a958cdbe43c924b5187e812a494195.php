...
<section class="content-header">
    ...
    <section class="content">
        ...
        <div class="col-md-3">
          ...
          <div class="box box-primary">
            <div class="box-body box-profile">
              ...
              <h3 class="text-center"><?php echo e($tripInfo->price."ج.س"); ?></h3>
              <p class="text-muted text-center"><?php echo e(tripStatus()[$tripInfo->status]); ?></p>
              <ul class="list-group list-group-unbordered">
                <li class="list-group-item">
                  <b> عدد التذاكر المتاحة</b> <a class="pull-left"><span class="label label-success"><?php echo e($tripInfo->seats_number - $tripInfo->reservations->count()); ?></span></a>
                </li>
                <li class="list-group-item">
                  <b> عدد التذاكر المحجوزة</b> <a class="pull-left"><span class="label label-danger"><?php echo e($tripInfo->reservations->count()); ?></span></a>
                </li>
                <li class="list-group-item">
                  <b> التاريخ</b> <a class="pull-left"><?php echo e($tripInfo->date); ?></a>
                </li>
                <li class="list-group-item">
                  <b>زمن المغادرة</b> <a class="pull-left"><?php echo e($tripInfo->departure_time); ?></a>
                </li>
              </ul>
              <a href="<?php echo e(route('trips.edit',  ['id' => $tripInfo->id])); ?>" class="btn btn-primary btn-block"><b>تعديل بيانات الشركة</b></a>
            </div>
            <!-- /.box-body -->
          </div>
          <!-- /.box -->
          ...
          <div class="box box-primary">
            ...
            <div class="box-body">
              ...
              <p class="text-muted">
                  <?php echo e($tripInfo->description); ?>

              </p>
              <hr>
              <strong><i class="fa fa-map-marker margin-r-5"></i> المسار</strong>
              <p class="text-muted"><?php echo e($tripInfo->fromStation->name); ?> -> <?php echo e($tripInfo->toStation->name); ?></p>
              <hr>
      ...
      <!-- /.row -->
      <?php echo $__env->make('vehicle::trips.add', ['tripInfo' => $tripInfo], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php echo $__env->make('cpanel.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/barca/fouad/works/a7jiz/a7giz-24/Modules/Reservation/Providers/../Resources/views/reservations/show.blade.php ENDPATH**/ ?>