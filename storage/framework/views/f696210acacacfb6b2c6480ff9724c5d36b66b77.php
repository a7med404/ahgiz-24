...
<script type="text/javascript">
    ...
    $('#data tfoot th').each( function () {
        ...
        var table = $('#data').DataTable({
            ...
            autoWidth: false,
            select: true,
            ajax: '<?php echo route('dones-dataTables'); ?>',
            columns: [
...
<?php echo $__env->make('adminCpanel.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/barca/fouad/works/a7jiz/a7giz-24/Modules/Reservation/Providers/../Resources/views/reservations/done.blade.php ENDPATH**/ ?>