    ...
    var lastIdx = null;
        ...
        $('#data tfoot th').each( function () {
            if($(this).index() < 4 || $(this).index() == 5){
                ...
                $(this).html( '<select data-column="'+ $(this).index() +'" class="filter-select select2 form-control"><option value=""> all </option><option value="<?php echo e(maleOrfemale()[0]); ?>">   </option><option value="<?php echo e(maleOrfemale()[1]); ?>"> ذكر </option></select>' );
            }
        });
...
<?php echo $__env->make('adminCpanel.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/barca/fouad/works/a7jiz/a7giz-24/Modules/Customer/Providers/../Resources/views/customers/index.blade.php ENDPATH**/ ?>