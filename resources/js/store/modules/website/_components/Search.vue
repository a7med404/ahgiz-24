                ...
                <div class="tab-pane fade active in" id="pills-all" role="tabpanel" aria-labelledby="pills-all-tab"> 
                        ...
                        <!-- {{-- <div class="inline-items search-list">
                            ...
                            <span class="search-icon">
                                <svg class="olymp-small-pin-icon"><use xlink:href="modules/master/website/svg-icons/sprites/icons.svg#olymp-small-pin-icon"></use></svg>
                            </span>
                        </div> --}} -->

                <form class="form" action="search-post" method="post"> 
                        <!-- @csrf -->
                    <div class="row">
                    ...
                    <div class="level col-md-3 col-sm-3"> 
                        <svg class="olymp-month-calendar-icon icon"><use xlink:href="modules/master/website/svg-icons/sprites/icons.svg#olymp-month-calendar-icon"></use></svg>
                    ...
                    <div class="search-btn col-md-3 col-sm-3"> 
                        ...
                        <svg class="olymp-magnifying-glass-icon"><use xlink:href="modules/master/website/svg-icons/sprites/icons.svg#olymp-magnifying-glass-icon"></use></svg>
                    </div>
                    </div>
                </form>
                </div>
